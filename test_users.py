...
class AllTests(unittest.TestCase):
    ...
    def test_users_cannot_login_unless_registered_or_form_valid(self):
    ...
    def test_form_is_present_on_register_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'input id="email" name="email" placeholder="email address" required', response.data)
